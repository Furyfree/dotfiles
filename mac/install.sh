...
# install.sh - Mac-specific installation script for dotfiles (symlinks only)
# Usage: ./install.sh
...
print_header() {
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
    echo -e "${WHITE}  🍎 Mac Dotfiles Symlink Setup${NC}"
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
}
...
main() {
    ...
    # Setup Mac-specific configurations
    if [[ -d "$MAC_DIR" ]]; then
        setup_configs "$MAC_DIR" "Mac-specific"
    else
        print_warning "Mac directory not found: $MAC_DIR"
    fi

    echo ""
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
    print_success "Mac dotfiles symlink setup completed!"
