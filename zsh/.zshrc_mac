...
alias brewclean="brew autoremove && brew cleanup -s --prune=all"
...
# Ladybird
alias ladybird='(cd ~/ladybird && PYTHONPATH=. python3 Meta/ladybird.py run ladybird)'
...
alias drc='sudo darwin-rebuild check --flake ~/nix-darwin'
alias dru='sudo darwin-rebuild switch --flake ~/nix-darwin && brew update && brew upgrade'
